                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      transition: 'opacity 0.35s cubic-bezier(0.22, 1, 0.36, 1), box-shadow 0.35s cubic-bezier(0.22, 1, 0.36, 1)',
                    }}
                  />
    ...
    <>
      <style>{`
        .cta-btn {
          ...
          padding: 15px 32px;
          cursor: pointer;
          transition: transform 0.55s cubic-bezier(0.16, 1, 0.30, 1), box-shadow 0.55s cubic-bezier(0.16, 1, 0.30, 1), background 0.45s ease;
          white-space: nowrap;
          animation: cta-glow-breathe 6.5s ease-in-out infinite;
          position: relative;
          overflow: hidden;
        }
        .cta-btn:hover {
          ...
          background: #E6A15A;
          box-shadow: 0 12px 56px rgba(230,161,90,0.46), 0 0 0 1px rgba(230,161,90,0.14), 0 0 80px rgba(230,161,90,0.10);
        }
