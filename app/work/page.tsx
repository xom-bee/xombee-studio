...
const projects = [
  {
    number: '01',
    title: 'Druk Art Hub',
    description: 'I designed the cultural identity and built the platform — so Bhutanese artistry reaches the world without losing what it is.',
  ...
  },
  {
    ...
    description: 'I designed and built a space where the artist\'s presence arrives before the sound does.',
  ...
  },
  {
    number: '03',
    title: 'Scan2Dine',
    description: 'I designed a dining system built to disappear — QR menus that remove friction so the meal stays central.',
    role: 'UI/UX Design · Frontend Development',
    status: null,
    href: '/work/scan2dine',
  },
  {
    number: '04',
    title: 'Q-Less',
    description: 'Hospital waiting, redesigned — a queue system built to respect the patient\'s time as much as their care.',
    role: 'UI/UX Design',
    status: null,
    href: '/work/q-less',
  },
      ...
      >
        ...
        <div style={{ marginBottom: 'clamp(56px, 8vw, 80px)' }}>
          ...
          <p style={{
            ...
            Work that begins with feeling and ends with code — each project a different question about how design creates presence.
          </p>
        </div>
...
const btnStyle = {
  ...
  flexShrink: 0,
  textDecoration: 'none',
  transition: 'color 0.45s cubic-bezier(0.22, 1, 0.36, 1), border-color 0.45s cubic-bezier(0.22, 1, 0.36, 1), background 0.45s cubic-bezier(0.22, 1, 0.36, 1)',
}
